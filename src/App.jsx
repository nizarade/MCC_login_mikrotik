...
const App = () => {
  return (
    <div className="bg-[url(./assets/bg_vertical.png)]  bg-cover bg-center w-screen h-full md:bg-[url(./assets/bg_horizontal.png)] lg:h-screen overflow-hidden">
      ...
      <div className="flex flex-col items-center   justify-center md:flex-row grid-cols-2 gap-2 md:py-10 ">
        <div className=" md:max-w-lg lg:max-w-xl mx-auto my-auto p-4 ">
        ...
        <div className=" flex flex-col items-center  md:w-2xl justify-center w-full mx-auto p-11 ">
